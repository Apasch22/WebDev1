(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[133],{"0WIc":function(e,t,r){window,n=function(){return function(e){var t={}
...
for(var n=0,l=r;n<l.length;n++){var c=l[n]
c.setAttribute("role","button")
var d=c.getAttribute("data-locale")||"en"
switch(c.setAttribute("aria-label",s(d)),c.getAttribute("data-button-style")||"icon"){case"icon":o(c)
break
case"text":a(c)
break
case"iconAndText":o(c),i(c),a(c)}}}},function(e,t,r){"use strict"
...
return new RegExp("^([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9\\-]{0,61}[a-zA-Z0-9])$").test(e)}t.launchAsync=function(e,t,r,c){return s?Promise.reject("Immersive Reader is already launching"):new Promise((function(d,u){if(e)if(r)if(r.chunks)if(r.chunks.length)if(l(t)||c&&c.customDomain){s=!0
var m=Date.now();(c=n({uiZIndex:1e3,timeout:15e3,useWebview:!1,allowFullscreen:!0,hideExitButton:!1,cookiePolicy:o.CookiePolicy.Disable},c)).uiZIndex&&"number"==typeof c.uiZIndex||(c.uiZIndex=1e3)
var h=null,v=document.createElement("div"),p=c.useWebview?document.createElement("webview"):document.createElement("iframe")
p.allow="autoplay"
var f=document.createElement("style")
f.innerHTML="body{height:100%;overflow:hidden;}"
var b=function(){h&&(window.clearTimeout(h),h=null)},g=function(){document.body.contains(v)&&document.body.removeChild(v),window.removeEventListener("message",k),b(),f.parentNode&&f.parentNode.removeChild(f)},y=function(){if(g(),c.onExit)try{c.onExit()}catch(e){}}
g()
var k=function(n){if(n&&n.data&&"string"==typeof n.data)if("ImmersiveReader-ReadyForContent"===n.data){b()
var o={cogSvcsAccessToken:e,cogSvcsSubdomain:t,request:r,launchToPostMessageSentDurationInMs:Date.now()-m,disableFirstRun:c.disableFirstRun,readAloudOptions:c.readAloudOptions,translationOptions:c.translationOptions,displayOptions:c.displayOptions,sendPreferences:!!c.onPreferencesChanged,preferences:c.preferences}
...
try{f=JSON.parse(n.data.substring("ImmersiveReader-LaunchResponse:".length))}catch(e){}f&&f.success?l={container:v,sessionId:f.sessionId,charactersProcessed:f.meteredContentSize}:h=f&&!f.success?{code:f.errorCode,message:a[f.errorCode],sessionId:f.sessionId}:{code:i.ErrorCode.ServerError,message:a[i.ErrorCode.ServerError]},s=!1,l?(b(),d(l)):h&&(y(),u(h))}else if(n.data.startsWith("ImmersiveReader-Preferences:")&&c.onPreferencesChanged&&"function"==typeof c.onPreferencesChanged)try{c.onPreferencesChanged(n.data.substring("ImmersiveReader-Preferences:".length))}catch(e){}}
window.addEventListener("message",k),h=window.setTimeout((function(){g(),s=!1,u({code:i.ErrorCode.Timeout,message:"Page failed to load after timeout ("+c.timeout+" ms)"})}),c.timeout),c.allowFullscreen&&p.setAttribute("allowfullscreen",""),p.style.cssText="position: static; width: 100vw; height: 100vh; left: 0; top: 0; border-width: 0",c.useWebview&&p.addEventListener("loadstop",(function(){p.contentWindow.postMessage(JSON.stringify({messageType:"WebviewHost"}),"*")}))
var w=(c.customDomain?c.customDomain:"https://"+t+".cognitiveservices.azure.com/immersivereader/webapp/v1.0/")+"reader?exitCallback=ImmersiveReader-Exit&sdkPlatform=js&sdkVersion=1.1.0"
w+="&cookiePolicy="+(c.cookiePolicy===o.CookiePolicy.Enable?"enable":"disable"),c.hideExitButton&&(w+="&hideExitButton=true"),c.uiLang&&(w+="&omkt="+c.uiLang),p.src=w,v.style.cssText="position: fixed; width: 100vw; height: 100vh; left: 0; top: 0; border-width: 0; -webkit-perspective: 1px; z-index: "+c.uiZIndex+"; background: white; overflow: hidden",v.appendChild(p),document.body.appendChild(v),document.head.appendChild(f)}else u({code:i.ErrorCode.InvalidSubdomain,message:a[i.ErrorCode.InvalidSubdomain]})
...
Object.defineProperty(t,"__esModule",{value:!0}),t.ErrorCode=void 0,function(e){e.BadArgument="BadArgument",e.Timeout="Timeout",e.TokenExpired="TokenExpired",e.Throttled="Throttled",e.ServerError="ServerError",e.InvalidSubdomain="InvalidSubdomain"}(t.ErrorCode||(t.ErrorCode={}))}])},e.exports=n()
var n},AZYJ:function(e,t,r){"use strict"
r.r(t)
r.d(t,"ImmersiveReaderButton",(function(){return E}))
r.d(t,"initializeReaderButton",(function(){return P}))
var n=r("RtDj")
r("q1tI")
var o=r("i8i4")
var i=r.n(o)
...
var m=r("0WIc")
var h=r("JGuX")
const v=".math_equation_latex"
const p=function(e,t){var r,n,o
if(!e)return""
const i=t.parseFromString(e,"text/html").body
const a=null===(r=i.querySelector(v))||void 0===r?void 0:r.parentElement
...
return i.innerHTML}
var f=p
var b;(function(e){e["mathML"]="application/mathml+xml"
e["html"]="text/html"})(b||(b={}))
class g{constructor(e={}){this.selector=void 0
...
t.push({content:this.applyFormatters(o),mimeType:b.html})
if(n)t.push({content:n.getAttribute(this.mathMLAttr)||"",mimeType:b.mathML})
else if(!n)return t
t.push(...this.chunk(i))
return t}applyFormatters(e){let t=e
this.formatters.forEach(e=>{t=e(t,this.parser)})
return t}bodyFor(e){return this.parser.parseFromString(e,"text/html").body}}var y=g
var k,w
const C=Object(c["useScope"])("ImmersiveReader")
...
function x({title:e,content:t},n){(n||Promise.resolve().then(r.t.bind(null,"0WIc",7))).then(({launchAsync:r})=>{fetch("/api/v1/immersive_reader/authenticate",u["e"]).then(e=>e.json()).then(({token:n,subdomain:o})=>{const i=(new y).chunk(t())
const a={title:e,chunks:i}
const s={cookiePolicy:m["CookiePolicy"].Disable}
r(n,o,a,s)}).catch(e=>{console.error("Getting authentication details failed",e)
Object(d["c"])(C.t("Immersive Reader Failed to Load"))()})}).catch(e=>{console.error("Loading the Immersive Reader SDK failed",e)
Object(d["c"])(C.t("Immersive Reader Failed to Load"))()})}function E({content:e,readerSDK:t,breakpoints:r}){return null!==r&&void 0!==r&&r.mobileOnly?Object(n["a"])(a["a"],{onClick:()=>x(e,t),screenReaderLabel:C.t("Immersive Reader")},void 0,k||(k=Object(n["a"])(l["a"],{src:L}))):Object(n["a"])(s["a"],{onClick:()=>x(e,t),renderIcon:w||(w=Object(n["a"])(l["a"],{src:L}))},void 0,C.t("Immersive Reader"))}const I=Object(h["a"])(E)
function P(e,t){i.a.render(Object(n["a"])(I,{content:t}),e)}}}])

//# sourceMappingURL=133-c-6767c6af82.js.map